...
'''
# TEST_MODE variable to decide what to run
if TEST_MODE:
    ...
    for entry in batch_data:
        ...
        request_object = {
            ...
            "body": {
                ...
                "messages": [
                    {"role": "system", "content": "Answer using only a short phrase, date, or entity. Do not use full sentences or restate the question, no explanation required."}, #Answer as concisely as possible, maximum of one sentence if needed.
                    {"role": "user", "content": entry['question']}
                ],
                "max_completion_tokens": 100 # Limit the response length, so we don't get a whole paragraph. (concise)
            }
        }
        # Write the line
...
# Get the file ID of the results
